%% SITLESS 1Back Script - created by Katherine McDonald 5/2/2022, version R2018b MATLAB, version 14.1.2 EEGLAB, version 7.0.0 ERPLAB
...
eeglab;
m_path = '/Users/katherinemcdonald/Library/CloudStorage/Box-Box/Data_Reduction (pindus@illinois.edu)/EEG/PA_CON/POST/1B/Combined_Targets/'; 
...
% Assign Bins
 EEG  = pop_binlister( EEG , 'BDF', [m_path '1Back_BinLister.txt'], 'ExportEL', ...
...
ERP = pop_binoperator( ERP, {'b10 = (b1+b2+b3+b4)/4 label Targets',...
    'b11 = (b5+b6+b7+b8+b9)/5 label NonTargets'}); 
...
ERP = pop_savemyerp(ERP, 'erpname', 'SITless_PA_CON_POST_1B_Targets', 'filename', 'SITless_PA_CON_POST_1B_Targets.erp', 'filepath', [m_path 'ERPsets/'], 'Warning', 'off');   
pop_export2text( ERP, [m_path 'Export_Excel/GrandAVG/','SITless_PA_CON_POST_1B_Targets','_erp_export.txt'], [10 11], 'electrodes', 'on', 'precision',4, 'time', 'on', 'timeunit',0.001 );
