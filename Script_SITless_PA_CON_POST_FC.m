...
eeglab;
m_path = '/Users/katherinemcdonald/Library/CloudStorage/Box-Box/Data_Reduction (pindus@illinois.edu)/EEG/PA_CON/POST/FC/Combined/'; 
...
ERP = pop_savemyerp(ERP, 'erpname', 'SITless_PA_CON_POST_FC', 'filename', 'SITless_PA_CON_POST_FC.erp', 'filepath', [m_path 'ERPsets/'], 'Warning', 'off');   
pop_export2text( ERP, [m_path 'Export_Excel/GrandAVG/','SITless_PA_CON_POST_FC','_erp_export.txt'], [13 14], 'electrodes', 'on', 'precision',4, 'time', 'on', 'timeunit',0.001 );
