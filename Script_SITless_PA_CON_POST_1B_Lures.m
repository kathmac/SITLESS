...
eeglab;
m_path = '/Users/katherinemcdonald/Library/CloudStorage/Box-Box/Data_Reduction (pindus@illinois.edu)/EEG/PA_CON/POST/1B/Combined_Lures/'; 
...
ERP = pop_savemyerp(ERP, 'erpname', 'SITless_PA_CON_POST_1B_Lures', 'filename', 'SITless_PA_CON_POST_1B_Lures.erp', 'filepath', [m_path 'ERPsets/'], 'Warning', 'off');   
pop_export2text( ERP, [m_path 'Export_Excel/GrandAVG/','SITless_PA_CON_POST_1B_Lures','_erp_export.txt'], [10 11], 'electrodes', 'on', 'precision',4, 'time', 'on', 'timeunit',0.001 );
