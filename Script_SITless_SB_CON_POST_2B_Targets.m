...
eeglab;
m_path = '/Users/katherinemcdonald/Library/CloudStorage/Box-Box/Data_Reduction (pindus@illinois.edu)/EEG/SB_CON/POST/2B/Combined_Targets/'; 
...
ERP = pop_savemyerp(ERP, 'erpname', 'SITless_SB_CON_POST_2B_Targets', 'filename', 'SITless_SB_CON_POST_2B_Targets', 'filepath', [m_path 'ERPsets/'], 'Warning', 'off');   
pop_export2text( ERP, [m_path 'Export_Excel/GrandAVG/','SITless_SB_CON_POST_2B_Targets','_erp_export.txt'], [10 11], 'electrodes', 'on', 'precision',4, 'time', 'on', 'timeunit',0.001 );
