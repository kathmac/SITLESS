%% SITLESS Flanker Script - created by Katherine McDonald 10/1/2021, version R2018b MATLAB, version 14.1.2 EEGLAB, version 7.0.0 ERPLAB
...
eeglab;
m_path = '/Users/katherinemcdonald/Library/CloudStorage/Box-Box/Data_Reduction (pindus@illinois.edu)/EEG/SB_CON/POST/FC/Combined/'; 
...
Subject_list_struct = dir('*FC*.set'); % grab set files 
...
% Assign Bins
 EEG  = pop_binlister( EEG , 'BDF', [m_path 'Flanker_BinLister_DMP.txt'], 'ExportEL', ...
...
ERP = pop_savemyerp(ERP, 'erpname', 'SITless_SB_CON_POST_FC', 'filename', 'SITless_SB_CON_POST_FC.erp', 'filepath', [m_path 'ERPsets/'], 'Warning', 'off');   
pop_export2text( ERP, [m_path 'Export_Excel/GrandAVG/','SITless_SB_CON_POST_FC','_erp_export.txt'], [13 14], 'electrodes', 'on', 'precision',4, 'time', 'on', 'timeunit',0.001 );
